...
window.logoutCoordinator = {
    ...
    performLogout: function() {
        ...
        // Анимированная перезагрузка страницы с технической темой
        if (typeof animatedReload === 'function') {
            // Используем функцию анимированной перезагрузки с технической темой
            animatedReload(400, false, '', '', 'tech');
        } else {
